...
_ROUTES: dict[str, RecommendationRoute] = {
    ...
    "profile.headline_quality_issue": RecommendationRoute(
        ...
        action_route="/profile/profile.headline_optimizer",
        estimated_impact_points=5,
    ...
    "profile.about_quality_issue": RecommendationRoute(
        ...
        action_route="/profile/profile.about_generator",
        estimated_impact_points=5,
        action_tool_id="profile.about_generator",
    ),
    "profile.experience_quality_issue": RecommendationRoute(
        ...
        action_route="/profile/profile.experience_optimizer",
        estimated_impact_points=5,
        action_tool_id="profile.experience_optimizer",
    ),
