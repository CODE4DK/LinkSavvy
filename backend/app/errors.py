...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.AI_OUTPUT_INVALID: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.AI_POLICY_BLOCKED: status.HTTP_422_UNPROCESSABLE_CONTENT,
    ErrorCode.AI_PROVIDER_UNAVAILABLE: status.HTTP_502_BAD_GATEWAY,
    ErrorCode.WEBHOOK_SIGNATURE_INVALID: status.HTTP_400_BAD_REQUEST,
    ErrorCode.BILLING_PROVIDER_ERROR: status.HTTP_502_BAD_GATEWAY,
    ErrorCode.NO_ACTIVE_SUBSCRIPTION: status.HTTP_404_NOT_FOUND,
}
